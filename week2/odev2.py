...
import pandas as pd
import numpy as np
df = pd.read_csv("week2/persona.csv")
...
yasaraliklari = [0, 18, 23, 30, 40, agg_df["AGE"].max()]
etiketler = ['0_18', '19_23', '24_30', '31_40', f"41_{agg_df['AGE'].max()} "]
agg_df['AGE_CAT'] = pd.cut(agg_df['AGE'], bins=yasaraliklari, labels=etiketler)
...
#for i in zip(agg_df["COUNTRY"],agg_df["SOURCE"],agg_df["SEX"],agg_df["AGE_CAT"]):
#    print(i)
