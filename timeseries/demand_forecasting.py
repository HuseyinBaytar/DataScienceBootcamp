...
train = pd.read_csv('timeseries/datasets/demand_forecasting/train.csv', parse_dates=['date'])
test = pd.read_csv('timeseries/datasets/demand_forecasting/test.csv', parse_dates=['date'])
